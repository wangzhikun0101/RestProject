package com.westvalley.g.materiel.allocation;
...
/*
 *copy right (C) 2019-2021,惠昌电子
 *ClasName :WareHouseAllocation
 *Author:shartten(王)
 *E-mail:
 *Date:2021-03-03 16:42
 *Description:
 */
public class WareHouseAllocation extends BaseAction {
    /**
     * 操作：
     * 		回写成败相关信息
     */
